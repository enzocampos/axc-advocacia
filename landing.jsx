...
const BENEFITS = [
  ...
  { k: 'Condução ativa',     v: 'Etapa por etapa, com prazo monitorado. Não dá para prometer rapidez — dá para prometer que não vai ficar esquecido.' },
];
...
const OBJECTIONS = [
  ...
  { q: '"Isso vai demorar anos."',
    a: 'Inventário demora quando ninguém conduz. A AXC trabalha exatamente o contrário: condução ativa, etapa por etapa. Não dá para prometer prazo sem ver seu caso — mas dá para prometer que ele não vai ficar esquecido numa gaveta.' },
  { q: '"Não posso agora."',
    a: 'A conversa inicial não te compromete com nada nem com nenhum prazo. E quanto mais o inventário fica parado, mais a burocracia se acumula. Entender sua situação hoje não custa nada — e te dá clareza para decidir o melhor momento.' },
];

const FAQS = [
  { q: 'Meu inventário já começou com outro advogado e travou. Dá para assumir?',
    a: 'Sim. O escritório pode assumir casos já iniciados, avaliar o que falta e retomar a condução.' },
  { q: 'Preciso ir até Louveira?',
    a: 'Não necessariamente. O atendimento pode ser presencial em Louveira/SP ou online, o que for melhor para você.' },
  { q: 'Quanto custa?',
  ...
  { q: 'A família toda precisa concordar para começar?',
  ...
  { q: 'Como funciona o atendimento depois?',
    a: 'Direto com o Dr. Anderson. Você não é repassado para estagiário — quem conduz seu caso é o advogado.' },
];
...
const TESTIMONIALS = [
  ...
  { idx: '02',
    quote: 'Fiz o atendimento todo online, moro em outro estado. O Dr. Anderson foi direto, sem transferir para estagiário nenhum. Sempre soube o que estava acontecendo com o meu caso. Recomendo sem hesitar.',
...
const SECTION_COPY = {
  ...
  solucaoP2: 'O jeito da AXC é o contrário disso. O Dr. Anderson assume a condução do caso do começo ao fim: levanta o que falta, organiza a documentação, conduz cada etapa e mantém você informado em linguagem que dá para entender.',
  ...
  resultadosSub: 'Cada inventário tem suas particularidades. O que se repete é o método: condução firme, comunicação clara e disposição para resolver — não para empurrar com a barriga.',
